...
if __name__ == "__main__":
    ...
    # parser.add_argument("--prompt", type=str, help="A single prompt.", default="a dog")
    parser.add_argument("--prompt", type=str, help="A single prompt.", default="An astronaut riding a horse on the moon, oil painting by Van Gogh.")
