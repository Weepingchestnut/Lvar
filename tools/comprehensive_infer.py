...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_dir', type=str, default='work_dir/infer_test/com_infer')
    ...
    if args.out_dir:
        ...
        out_dir = osp.join(
            'output', osp.basename(osp.dirname(args.model_path)), 
    ...
    for i, infer_data in enumerate(lines4infer):
        try:
            ...
            # save_file = osp.join(out_dir, 'pred', f'{i}.jpg')
