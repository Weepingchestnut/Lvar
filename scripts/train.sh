...
data_path='datasets/infinity_toy_data/splits'
video_data_path=''
...
--Ct5=2048 \
--t5_path=pretrained_models/infinity/flan-t5-xl \
--vae_type 32 \
--vae_ckpt=pretrained_models/infinity/Infinity/infinity_vae_d32.pth \
--wp 0.00000001 \
--wpe=1 \
