...
infer_eval_image_reward() {
    ...
    torchrun --nproc_per_node=${gpu_num} --master-port ${master_port} evaluation/image_reward/infer4eval_ddp.py \
        ...
        --outdir ${out_dir} \
        --skip_last_scales ${skip_last_scales} 2>&1 | tee ${out_dir}/eval_image-reward.log
...
test_gen_eval() {
    ...
    torchrun --nproc_per_node=${gpu_num} --master-port ${master_port} evaluation/gen_eval/infer4eval_ddp.py \
        ...
        --skip_last_scales ${skip_last_scales} 2>&1 | tee ${out_dir}/eval_gen-eval.log
    ...
    python tools/compute_metrics.py \
        ...
        --input_root_gts work_dir/evaluation/gen_eval/infinity_8b_skip-0/gen_eval_cfg4_tau1_cfg_insertion_layer0_rewrite_prompt1_round2_real_rewrite/images \
...
model_exp=${model_type}_skip-${skip_last_scales}
