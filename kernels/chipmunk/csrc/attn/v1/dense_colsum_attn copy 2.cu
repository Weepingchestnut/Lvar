...
dense_colsum_attn(at::Tensor q, at::Tensor k, at::Tensor v, at::Tensor p)
{
    ...
    constexpr int K_SEQUENCE_STRIDE_PADDING = 16 / sizeof(bf16); 
    const uint kseq_len_padded = static_cast<uint>((kseq_len + K_SEQUENCE_STRIDE_PADDING - 1) / K_SEQUENCE_STRIDE_PADDING * K_SEQUENCE_STRIDE_PADDING);
