...
class _attention(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, q, k, v, causal, sm_scale=None, warp_specialize=True):
        # shape constraints
        ...
        sm_scale = 1/math.sqrt(HEAD_DIM_K) if sm_scale is None else sm_scale
        ...
        # TODO 对齐 sparse_attn 中的 dense_attn，还需要L
...
def flash_attn_triton(q, k, v, scale=None):
    return _attention.apply(q, k, v, False, scale)


def attn_simple_test():
    """
