...
for seqlen in range(4096*8, 4096*8+128, 128):
    for is_contiguous in [False, True]:
        ...
        print(f"\nis_contig={is_contiguous}, seqlen: {seqlen} (% 192 = {seqlen % 192}, % 128 = {seqlen % 112}), o_max_diff: {o_max_diff:.2f}, o_mean_diff: {o_mean_diff:.2f}")
