...
from data.build import build_t2i_dataset
import utils.dist as dist
from utils import arg_util, misc, wandb_utils
from utils.save_and_load import CKPTSaver, auto_resume
...
def build_model_optimizer(args, vae_ckpt):
    ...
    from models.infinity.infinity_model import Infinity, MultipleLayers
    from models.init_param import init_weights
    from utils.amp_sc import AmpOptimizer
    from utils.lr_control import filter_params
    from utils.load import build_vae_gpt
