...
from .configuration_disc import NLayerDiscriminatorConfig
...
class NLayerDiscriminator(PreTrainedModel):
    ...
    def __init__(self, config: NLayerDiscriminatorConfig):
        input_nc, ndf, n_layers, use_actnorm = (
            config.input_nc,
            config.ndf,
            config.n_layers,
            config.use_actnorm,
