...
from .basic_grn import FastRMSNorm, SelfAttnBlock
from .flex_attn_mask import build_flex_attn_func
from .rope import precompute_rope3d_freqs_grid
from models.schedules.dynamic_resolution import grn_get_dynamic_resolution_meta
from utils.dist import for_visualize
from models.schedules.global_refine import multiclass_labels2onehot_input
from utils.sequence_parallel import SequenceParallelManager as sp_manager
from utils.sequence_parallel import sp_gather_sequence_by_dim, sp_split_sequence_by_dim
...
class GRN(nn.Module):
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.dynamic_resolution_h_w, self.h_div_w_templates = grn_get_dynamic_resolution_meta(
    ...
    def autoregressive_infer(
        ...
        **kwargs: Any,
        ...
        from models.schedules.global_refine import shift_pt
        ...
        if args.refine_mode == 'ar_discrete_GRN_ind':
            from .hbq_util_t2iv import index_label2quant_features
            ...
            from .hbq_util_t2iv import bit_label2raw_feature
