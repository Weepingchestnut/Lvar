...
from .load import load_visual_tokenizer
from models.schedules.dynamic_resolution import grn_get_dynamic_resolution_meta, get_first_full_spatial_size_scale_index
...
class GRNPipeline:
    ...
    def __call__(
        ...
        **kwargs
        ...
        dynamic_resolution_h_w, h_div_w_templates = grn_get_dynamic_resolution_meta(
