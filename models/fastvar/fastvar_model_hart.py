...
from models.fastvar.fastvar_basic_hart import FastVARAdaLNSelfAttn
...
from models.hart.hart_autoencoder import HARTAutoEncoder, HARTHybridQuantizer
from models.hart.hart_autoencoder_with_disc import HARTAutoEncoderWithDisc
from models.hart.hart_transformer_t2i import CopyableGenerator, mask_by_order
...
class FastVAR_HART(PreTrainedModel):
...
# AutoModel.register(HARTForT2IConfig, FastVAR_HART)
