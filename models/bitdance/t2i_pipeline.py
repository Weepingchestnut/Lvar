...
from models.bitdance.utils import MLPconnector
from models.bitdance.vision_encoder.autoencoder import VQModel
from models.bitdance.vision_head.flow_head_parallel_x import DiffHead
...
class BitDanceT2IPipeline:
    ...
    def generate(
        ...
        max_length = (height // self.vae_patch_size) * (width // self.vae_patch_size)       # 4096 for 1024x1024
